...
import { InventoryTransactionListRelationFilter } from "../../inventoryTransaction/base/InventoryTransactionListRelationFilter";
...
class ProductWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => InventoryTransactionListRelationFilter,
  })
  @ValidateNested()
  @Type(() => InventoryTransactionListRelationFilter)
  @IsOptional()
  @Field(() => InventoryTransactionListRelationFilter, {
    nullable: true,
  })
