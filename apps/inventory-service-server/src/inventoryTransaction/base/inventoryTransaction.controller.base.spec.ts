...
const service = {
  ...
  inventoryTransactions: () => FIND_MANY_RESULT,
  inventoryTransaction: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
...
describe("InventoryTransaction", () => {
  ...
  test("POST /inventoryTransactions", async () => {
  ...
  test("GET /inventoryTransactions", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /inventoryTransactions/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/inventoryTransactions"}/${nonExistingId}`)
  ...
  test("GET /inventoryTransactions/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/inventoryTransactions"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /inventoryTransactions existing resource", async () => {
